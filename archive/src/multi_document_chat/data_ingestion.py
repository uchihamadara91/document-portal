...
class DocumentIngestor:
    ...
    def __init__(self,temp_dir: str="data/multi_doc_chat",faiss_dir: str = "faiss_index",session_id: str | None = None):
        ...
        try:
            ...
            # Sessionized Paths
            self.session_id = session_id or f"session_{datetime.now(timezone.utc).strftime('%d%m%Y_%H%M%S')}_{uuid.uuid4().hex[:8]}"
            ...
            raise DocumentPortalException("Initializing Error DocumentIngestor", sys)
    ...
    def ingest_files(self, uploaded_files):
        try:
            ...
            if not documents:
                raise ValueError("No Valid Documents Loaded", sys)
            ...
            raise DocumentPortalException("Ingestion Error DocumentIngestor", sys)
    ...
    def _create_retriever(self, documents):
        try:
            ...
            raise DocumentPortalException("Retriver Error in DocumentIngestor", sys)
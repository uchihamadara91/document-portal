...
class DocumentHandler:
    ...
    def __init__(self, data_dir=None, session_id=None):
        try:
            ...
            self.session_id = session_id or f"session_{datetime.utcnow().strftime}_{uuid.uuid4().hex[:8]}"
    ...
    def save_pdf(self, uploaded_file):
        try:
            ...
            if not filename.lower().endswith(".pdf"):
                raise DocumentPortalException("Invalid filetype, Only PDFS")
...
if __name__ == "__main__":
    ...
    pdf_path = r"C:\\Users\\shank\\Downloads\\document_portal\\data\\document_analysis\\sample.pdf"

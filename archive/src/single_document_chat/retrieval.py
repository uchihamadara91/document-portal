...
class ConversationalRAG:
    def __init__(self,session_id: str, retriever):
        ...
        try:
            ...
            self.log.info("Created history aware retriver", session_is=session_id)
            ...
            self.log.error("Error loading ConversationalRAG", error=str(e), session_id=session_id)   
    ...
    def _get_session_history(self, session_id: str)-> BaseChatMessageHistory:
        try:
            ...
            self.log.error("Failed to access history", error=str(e), session_id=session_id)   
    ...
    def invoke(self, user_input: str)-> str:
        try:
            ...
            self.log.info("Chain invoked successfully", session_id=self.session_id, user_input=user_input, answer_preview=answer[:170])
            return answer

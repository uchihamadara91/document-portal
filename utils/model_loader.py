...
class ModelLoader:
    ...
    def _validate_env(self):
        """
        Validate necessary enviroment variables.
    ...
    def load_llm(self):
        ...
        Load LLM dynamically based on provider config
        ...
        provider_key = os.getenv("LLM Provider", "google")
        if provider_key not in llm_block:
            log.error("LLM provider not found inconfig", provider_key=provider_key)
